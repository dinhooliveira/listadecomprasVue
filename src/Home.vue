        ...
        <div class="col-md-12" style="overflow: auto">
            <table class="table mt-4 table-bordered">
                ...
                <tr v-for="(lista,index) in listas" v-bind:key="lista.id">
                    ...
                    <td style="width:50px">
                        <ul>
                            <li><a @click="editarLista(lista.id)" class="btn btn-sm btn-primary text-white m-1">Editar</a>
                            </li>
                            <li><a @click="removeLista(lista.id)" class="btn btn-sm btn-danger text-white m-1">Remover</a>
                            </li>
